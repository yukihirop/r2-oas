      ...
      module FromFiles
        class BaseObject
          ...
          def set_components_name_list(root_doc)
            obj_store.components_schema_name_list = (root_doc.dig('components', 'schemas') || {}).keys.sort.uniq
            obj_store.components_request_body_name_list = (root_doc.dig('components', 'schemas') || {}).keys.sort.uniq
          end
