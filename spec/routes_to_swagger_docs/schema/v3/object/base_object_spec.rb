...
RSpec.describe RoutesToSwaggerDocs::Schema::V3::BaseObject do
  ...
  describe '.initialize' do
    context 'when default' do
      ...
      it { expect(http_statuses_when_http_method[:get]).to eq :default=>["200", "422"], :path_parameter=>["200", "404", "422"] }
      it { expect(http_statuses_when_http_method[:post]).to eq :default=>["201", "422"], :path_parameter=>["201", "404", "422"] }
      it { expect(http_statuses_when_http_method[:patch]).to eq :default=>["204", "422"], :path_parameter=>["204", "404", "422"] }
      it { expect(http_statuses_when_http_method[:put]).to eq :default=>["204", "422"], :path_parameter=>["204", "404", "422"] }
      it { expect(http_statuses_when_http_method[:delete]).to eq  :default=>["200", "422"], :path_parameter=>["200", "404", "422"] }
